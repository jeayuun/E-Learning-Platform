;var MonsterInsights = function() {
    ...
    ;function A(e) {
        var f = h()
          ...
          , m = e.pathname;
        d = d.toString();
        var s, v, y = e.getAttribute('data-vars-ga-category');
        if (y) {
            return y
        }
        ;if (d.match(/^javascript\:/i)) {
            ...
            t = 'mailto'
        } else if (r && k && r.length > 0 && k.length > 0 && !r.endsWith('.' + k) && r !== k) {
            t = 'external'
        } else if (m && JSON.stringify(l) != '{}' && m.length > 0) {
            var b = l.length;
            for (var n = 0; n < b; n++) {
                if (l[n].path && l[n].label && l[n].path.length > 0 && l[n].label.length > 0 && m.startsWith(l[n].path)) {
        ...
        ;if (p && (t === 'unknown' || 'external' === t) && f.length > 0 && p.length > 0) {
            for (s = 0,
            v = f.length; s < v; ++s) {
                if (f[s].length > 0 && (d.endsWith(f[s]) || f[s] == p)) {
                    t = 'download';
                    break
                }
            }
    ...
    ;function p(n) {
        var a = n.srcElement || n.target, e = [], m;
        e.el = a;
        e.click_type = w(n);
        ...
        ;if (a && a.href && !a.hasAttribute('xlink:href')) {
            var p = a.href
              ...
              , o = A(a)
              , K = T(a, n)
              , y = a.getAttribute('data-vars-ga-action')
                ...
                if (K || o == 'mailto' || o == 'tel') {
                    if (o == 'download') {
                        ...
                        m = {
                            ...
                            email_address: p.replace('mailto:', ''),
    ...
    ;if (typeof Array.prototype.lastIndexOf !== 'function') {
        Array.prototype.lastIndexOf = function(e) {
            ...
            ;var t, n, l = Object(this), i = l.length >>> 0;
            if (i === 0) {
                return -1
            }
            ;t = i - 1;
