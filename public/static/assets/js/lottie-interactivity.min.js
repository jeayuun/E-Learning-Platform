      ...
      , c = function() {
        function e() {
                ...
                value: function() {
                    if (i.player) {
                        ...
                        i.stateHandler.set("loop", (function() {
                            i.actions[i.interactionIdx].loop ? i.player.loop = parseInt(i.actions[i.interactionIdx].loop) - 1 : i.player.loop = !0,
                            i.player.autoplay = !0
                        }
                        )),
            ...
            y.set(this, {
                writable: !0,
                value: function() {
                    0 === i.clickCounter ? (i.player.play(),
                    i.clickCounter++) : (i.clickCounter++,
            ...
            h.set(this, {
                ...
                value: function() {
                    ...
                    if ("chain" === i.mode) {
                        ...
                        return i.clickCounter = 0,
                        !e && "click" === n && "click" === t || "hover" === n && "hover" === t ? i.transitionHandler.get("onComplete").call() : i.nextInteraction(),
            ...
            f.set(this, {
                writable: !0,
                value: function() {
                    "loop" === i.actions[i.interactionIdx].state ? i.player.removeEventListener("loopComplete", o(i, f)) : i.player.removeEventListener("complete", o(i, f)),
                    i.nextInteraction()
                }
            }),
            L.set(this, {
                ...
                value: function(e) {
                    ...
                    i.playCounter >= n - 1 ? (i.playCounter = 0,
                    i.player.removeEventListener("loopComplete", t),
                    i.player.loop = !1,
                    i.player.autoplay = !1,
                    i.nextInteraction()) : i.playCounter += 1
                }
            }),
            E.set(this, {
                writable: !0,
                value: function() {
                    ...
                    e && i.player.currentFrame >= parseInt(e[1]) - 1 && (i.player.removeEventListener("enterFrame", o(i, E)),
            ...
            g.set(this, {
                ...
                value: function() {
                    var e = i.actions[i.interactionIdx].frames;
                    (e && i.player.currentFrame >= e[1] || i.player.currentFrame >= i.player.totalFrames - 1) && (i.player.removeEventListener("enterFrame", o(i, g)),
            ...
            w.set(this, {
                writable: !0,
                value: function() {
                    -1 !== i.player.playDirection && null !== i.holdStatus && i.holdStatus || (i.player.setDirection(1),
                    i.player.play(),
                    i.holdStatus = !0)
                }
            }),
            I.set(this, {
                writable: !0,
                value: function() {
                    "hold" === i.actions[i.interactionIdx].transition || "hold" === i.actions[i.interactionIdx].state || "hold" === i.actions[0].type ? (i.player.setDirection(-1),
                    i.player.play()) : "pauseHold" !== i.actions[i.interactionIdx].transition && "pauseHold" !== i.actions[i.interactionIdx].state && "pauseHold" !== i.actions[0].type || i.player.pause(),
                    i.holdStatus = !1
                }
            }),
            x.set(this, {
                writable: !0,
                value: function() {
                    if (i.container.removeEventListener("click", o(i, h)),
            ...
            a(this, "nextInteraction", (function() {
                ...
                t ? t >= 0 && t < i.actions.length ? (i.interactionIdx = t,
                o(i, S).call(i, {
                    ignorePath: !1
                })) : (i.interactionIdx = 0,
                ...
                i.interactionIdx >= i.actions.length ? i.actions[i.actions.length - 1].reset ? (i.interactionIdx = 0,
            ...
            b.set(this, {
                ...
                value: function(e) {
                    ...
                    if (!t)
                        return i.player.resetSegments(!0),
                ...
                value: function() {
                    ...
                    if (!e)
                        if ("object" === t(i.enteredPlayer) && "AnimationItem" === i.enteredPlayer.constructor.name) {
                            ...
                            if (n = n.substr(0, n.lastIndexOf(".json")),
                            i.player.fileName === n)
                                return void o(i, S).call(i, {
                                    ignorePath: !0
                                })
                    ...
                    if (i.container.setAttribute("style", r),
                    "object" !== t(i.enteredPlayer) || "AnimationItem" !== i.enteredPlayer.constructor.name) {
                        if ("string" == typeof i.enteredPlayer) {
                            ...
                            i.enteredPlayer instanceof HTMLElement && "LOTTIE-PLAYER" === i.enteredPlayer.nodeName && (i.attachedListeners || (i.enteredPlayer.addEventListener("ready", (function() {
                                i.container.style.width = "",
                                i.container.style.height = ""
                            }
                            )),
                        ...
                        if (!window.lottie)
                            throw new Error("".concat(l, " A Lottie player is required."));
                        i.stop(),
                        i.container.innerHTML = "",
                        "object" === t(e) && "AnimationItem" === e.constructor.name ? i.player = window.lottie.loadAnimation({
                            loop: !1,
                            autoplay: !1,
            ...
            S.set(this, {
                ...
                value: function(e) {
                    ...
                    t || !(s || i.actions[i.actions.length - 1].reset && 0 === i.interactionIdx) ? setTimeout((function() {
                        n && (i.player.autoplay = !1,
                        i.player.resetSegments(!0),
                        i.player.goToAndStop(n[0], !0)),
                        l ? l.call() : "none" === a && (i.player.loop = !1,
                        i.player.autoplay = !1),
                        c && c.call(),
                        i.player.autoplay && (i.player.resetSegments(!0),
                        o(i, b).call(i, !0)),
                        i.player.setSpeed(p)
                    }
                    ), d) : o(i, k).call(i)
                ...
                value: function(e, t) {
                    ...
                    if (a)
                        if ("seek" === a.type || "seek" === a.transition) {
                            ...
                            "loop" === a.type ? i.player.playSegments(a.frames, !0) : "play" === a.type ? (!0 === i.player.isPaused && i.player.resetSegments(),
                            i.player.playSegments(a.frames)) : "stop" === a.type && (i.player.resetSegments(!0),
                ...
                value: function() {
                    ...
                    if (t)
                        if ("seek" === t.type) {
                            ...
                            null !== i.assignedSegment && (i.player.resetSegments(!0),
                            i.assignedSegment = null),
                            i.player.goToAndStop(n + Math.round((e - t.visibility[0]) / (t.visibility[1] - t.visibility[0]) * (a - n)), !0)
                        } else if ("loop" === t.type)
                            i.player.loop = !0,
                            (null === i.assignedSegment || i.assignedSegment !== t.frames || !0 === i.player.isPaused) && (i.player.playSegments(t.frames, !0),
                            i.assignedSegment = t.frames);
                        else if ("play" === t.type || "playOnce" === t.type) {
                            if ("playOnce" === t.type && !i.scrolledAndPlayed)
                                return i.scrolledAndPlayed = !0,
                                i.player.resetSegments(!0),
                                void (t.frames ? i.player.playSegments(t.frames, !0) : i.player.play());
                            "play" === t.type && i.player.isPaused && (i.player.resetSegments(!0),
        ...
        (C = [{
            ...
            value: function() {
                ...
                this.player.stop(),
                this.container.addEventListener("click", o(this, h))) : "hover" === this.actions[0].type ? (this.player.loop = !1,
                this.player.stop(),
                ...
                this.player.stop(),
                this.container.addEventListener("click", o(this, y))) : "hold" === this.actions[0].type || "pauseHold" === this.actions[0].type ? (this.container.addEventListener("mouseenter", o(this, w)),
                ...
                this.container.addEventListener("mouseout", o(this, m))) : (this.player.loop = !0,
                this.player.stop(),
                this.container.addEventListener("mousemove", o(this, u)),
            ...
            value: function(e) {
                ...
                "object" !== t(o) || "AnimationItem" !== o.constructor.name) {
                    ...
                    if (!o)
                        throw new Error(l + "Specified player:" + o + " is invalid.",o)
                }
            ...
            key: "stop",
            value: function() {
                if ("scroll" === this.mode && window.removeEventListener("scroll", o(this, M), !0),
                "cursor" === this.mode && (this.container.removeEventListener("click", o(this, h)),
                ...
                "chain" === this.mode && (this.container.removeEventListener("click", o(this, h)),
