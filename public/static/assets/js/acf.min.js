    ...
    var t = {
                ...
                acf.hooks = new function() {
                    var t = {
                        removeFilter: function(e, i) {
                            return "string" == typeof e && n("filters", e, i),
                            t
                        },
                        applyFilters: function() {
                            var e = Array.prototype.slice.call(arguments)
                              , n = e.shift();
                            return "string" == typeof n ? o("filters", n, e) : t
                        },
                        addFilter: function(e, n, o, r) {
                            return "string" == typeof e && "function" == typeof n && i("filters", e, n, o = parseInt(o || 10, 10), r),
                            t
                        },
                        removeAction: function(e, i) {
                            return "string" == typeof e && n("actions", e, i),
                            t
                        },
                        doAction: function() {
                            var e = Array.prototype.slice.call(arguments)
                              , n = e.shift();
                            return "string" == typeof n && o("actions", n, e),
                            t
                        },
                        addAction: function(e, n, o, r) {
                            return "string" == typeof e && "function" == typeof n && i("actions", e, n, o = parseInt(o || 10, 10), r),
                            t
                        },
                        storage: function() {
                            return e
                        ...
                        if (e[t][n])
                            if (i) {
                                ...
                                if (o)
                                    for (r = a.length; r--; ) {
                                        var s = a[r];
                                        s.callback === i && s.context === o && a.splice(r, 1)
                                    }
                                else
                                    for (r = a.length; r--; )
                                        a[r].callback === i && a.splice(r, 1)
                            } else
                                e[t][n] = []
                    }
                    function i(t, n, i, o, r) {
                        ...
                        s = function(t) {
                            for (var e, n, i, o = 1, r = t.length; o < r; o++) {
                                for (e = t[o],
                                n = o; (i = t[n - 1]) && i.priority > e.priority; )
                                    t[n] = t[n - 1],
                                    --n;
                                t[n] = e
                            }
        ...
        2177: () => {
            !function(t, e) {
                acf.newTooltip = function(t) {
                    ...
                    t.confirmRemove !== e ? (t.textConfirm = acf.__("Remove"),
                    t.textCancel = acf.__("Cancel"),
                    new i(t)) : t.confirm !== e ? new i(t) : new n(t)
                }
                ;
                var n = acf.Model.extend({
                    ...
                    position: function() {
                        ...
                        if (n) {
                            ...
                            var i = n.outerWidth()
                              ...
                              , u = r - c - l
                              , f = a + i / 2 - s / 2;
                            f < 10 ? (e.addClass("right"),
                            f = a + i,
                            u = r + o / 2 - c / 2 - l) : f + s + 10 > t(window).width() ? (e.addClass("left"),
                            f = a - s,
                            u = r + o / 2 - c / 2 - l) : u - t(window).scrollTop() < 10 ? (e.addClass("bottom"),
                            u = r + o - l) : e.addClass("top"),
                            e.css({
                                top: u,
                                left: f
                            })
                  ...
                  , i = n.extend({
                    ...
                    addEvents: function() {
                        ...
                        this.get("targetConfirm") && this.on(n, "click", "onConfirm")
                    },
                    ...
                    render: function() {
                        var t = [this.get("text") || acf.__("Are you sure?"), '<a href="#" data-event="confirm">' + (this.get("textConfirm") || acf.__("Yes")) + "</a>", '<a href="#" data-event="cancel">' + (this.get("textCancel") || acf.__("No")) + "</a>"].join(" ");
                        this.html(t),
        ...
        2700: () => {
            ...
            e = acf.Model.extend({
                ...
                render: function() {
                    ...
                    this.get("dismiss") && (this.$el.append('<a href="#" class="acf-notice-dismiss acf-icon -cancel small"></a>'),
                ...
                show: function() {
                    var t = this.get("target")
                      , e = this.get("location");
                    t && ("after" === e ? t.append(this.$el) : t.prepend(this.$el))
                },
                hide: function() {
                    this.$el.remove()
                },
            ...
            new acf.Model({
                ...
                initialize: function() {
                    t(".acf-admin-notice").each((function() {
                        if (t(this).data("persisted")) {
                            let e = acf.getPreference("dismissed-notices");
                            e && "object" == typeof e && e.includes(t(this).data("persist-id")) ? t(this).remove() : (t(this).show(),
                            t(this).on("click", ".notice-dismiss", (function(n) {
                                e = acf.getPreference("dismissed-notices"),
                                e && "object" == typeof e || (e = []),
                                e.push(t(this).closest(".acf-admin-notice").data("persist-id")),
                                acf.setPreference("dismissed-notices", e)
                            }
                            )))
                        }
                    }
        ...
        4204: () => {
            ...
            acf.models.Popup = acf.Model.extend({
                ...
                lockFocusToPopup: function(e) {
                    let n = t("#wpwrap");
                    n.length && (n[0].inert = e,
                    n.attr("aria-hidden", e))
                },
                update: function(t) {
                ...
                returnFocusToOrigin: function() {
                    this.data.openedBy instanceof t && this.data.openedBy.closest("body").length > 0 && this.data.openedBy.trigger("focus")
                }
            }),
            ...
            acf.models.Modal = acf.Model.extend({
                ...
                render: function() {
                    var e = this.get("title")
                      , n = this.get("content")
                      , i = this.get("toolbar")
                      , o = t(["<div>", '<div class="acf-modal">', '<div class="acf-modal-title">', "<h2>" + e + "</h2>", '<button class="acf-modal-close" type="button"><span class="dashicons dashicons-no"></span></button>', "</div>", '<div class="acf-modal-content">' + n + "</div>", '<div class="acf-modal-toolbar">' + i + "</div>", "</div>", '<div class="acf-modal-backdrop acf-modal-close"></div>', "</div>"].join(""));
        ...
        6047: () => {
            !function(t, e) {
                ...
                n.uniqid = function(t, e) {
                    ...
                    return o || (o = Math.floor(123456789 * Math.random())),
                    o++,
                    n = t,
                ...
                n.strMatch = function(t, e) {
                    for (var n = 0, i = Math.min(t.length, e.length), o = 0; o < i && t[o] === e[o]; o++)
                        n++;
                    return n
                }
                ,
                ...
                var r = function(t, e, i) {
                    var o = (e = e.replace("[]", "[%%index%%]")).match(/([^\[\]])+/g);
                    if (o)
                        for (var r = o.length, a = t, s = 0; s < r; s++) {
                            var c = String(o[s]);
                            s == r - 1 ? "%%index%%" === c ? a.push(i) : a[c] = i : ("%%index%%" === o[s + 1] ? n.isArray(a[c]) || (a[c] = []) : n.isObject(a[c]) || (a[c] = {}),
                            a = a[c])
                        }
                };
                n.serialize = function(t, i) {
                    ...
                    i !== e && (a = a.filter((function(t) {
                        return 0 === t.name.indexOf(i)
                    }
                    )).map((function(t) {
                        return t.name = t.name.slice(i.length),
                        t
                    }
                    )));
                ...
                n.serializeForAjax = function(t) {
                    var e = {};
                    return n.serializeArray(t).map((function(t) {
                        "[]" === t.name.slice(-2) ? (e[t.name] = e[t.name] || [],
                        e[t.name].push(t.value)) : e[t.name] = t.value
                    }
                    )),
                    e
                }
                ...
                n.addAction = function(t, e, i, o) {
                    return n.hooks.addAction.apply(this, arguments),
                    this
                }
                ,
                n.removeAction = function(t, e) {
                    return n.hooks.removeAction.apply(this, arguments),
                    this
                }
                ;
                var a = {};
                ...
                n.addFilter = function(t) {
                    return n.hooks.addFilter.apply(this, arguments),
                    this
                }
                ,
                n.removeFilter = function(t) {
                    return n.hooks.removeFilter.apply(this, arguments),
                    this
                }
                ,
                ...
                var c = function(t) {
                    return "this." === t.substr(0, 5) && (t = t.substr(5) + "-" + n.get("post_id")),
                    t
                };
                ...
                var l = function(t) {
                  ...
                  , u = function(e) {
                    var n = e.target
                      , i = n.height()
                      , o = n.children().length
                      , r = t('<td class="acf-temp-remove" style="padding:0; height:' + i + 'px" colspan="' + o + '"></td>');
                ...
                n.duplicate = function(e) {
                    ...
                    var o = i.clone();
                    return e.rename && n.rename({
                        target: o,
                        search: e.search,
                        replace: e.replace,
                        replacer: "function" == typeof e.rename ? e.rename : null
                    }),
                    o.removeClass("acf-clone"),
                    o.find(".ui-sortable").removeClass("ui-sortable"),
                    o.find("[data-select2-id]").removeAttr("data-select2-id"),
                    o.find(".select2").remove(),
                    o.find('.acf-is-subfields select[data-ui="1"]').each((function() {
                        t(this).prop("id", t(this).prop("id").replace("acf_fields", n.uniqid("duplicated_") + "_acf_fields"))
                    }
                    )),
                    o.find(".acf-field-settings > .acf-tab-wrap").remove(),
                    e.after(i, o),
                ...
                n.rename = function(t) {
                    ...
                    t.replacer || (t.replacer = function(t, e, n, i) {
                        return e.replace(n, i)
                    }
                    );
                    var i = function(e) {
                        return function(n, i) {
                            return t.replacer(e, i, t.search, t.replace)
                        }
                    };
                    if (t.destructive) {
                        var o = n.strReplace(t.search, t.replace, e.outerHTML());
                        e.replaceWith(o)
                    } else
                        e.attr("data-id", t.replace),
                        e.find('[id*="' + t.search + '"]').attr("id", i("id")),
                        e.find('[for*="' + t.search + '"]').attr("for", i("for")),
                        e.find('[name*="' + t.search + '"]').attr("name", i("name"));
                    return e
                }
                ,
                n.prepareForAjax = function(t, e=!1) {
                    return (e || void 0 === t.nonce) && (t.nonce = n.get("nonce")),
                    t.post_id = n.get("post_id"),
                    n.has("language") && (t.lang = n.get("language")),
                ...
                n.val = function(t, e, n) {
                    var i = t.val();
                    return e !== i && (t.val(e),
                    t.is("select") && null === t.val() ? (t.val(i),
                    !1) : (!0 !== n && t.trigger("change"),
                    !0))
                }
                ,
                n.show = function(t, e) {
                    return e && n.unlock(t, "hidden", e),
                    !n.isLocked(t, "hidden") && !!t.hasClass("acf-hidden") && (t.removeClass("acf-hidden"),
                    !0)
                }
                ,
                n.hide = function(t, e) {
                    return e && n.lock(t, "hidden", e),
                    !t.hasClass("acf-hidden") && (t.addClass("acf-hidden"),
                    !0)
                }
                ,
                ...
                ;
                var f = function(t, e) {
                    return !(t.hasClass("acf-disabled") || (e && n.unlock(t, "disabled", e),
                    n.isLocked(t, "disabled") || !t.prop("disabled") || (t.prop("disabled", !1),
                    0)))
                };
                ...
                n.getFileInputData = function(t, e) {
                    ...
                    var o = {
                      ...
                      , r = !!t[0].files.length && n.isget(t[0].files, 0);
                    if (r)
                        if (o.size = r.size,
                        o.type = r.type,
                ...
                n.getXhrError = function(t) {
                    if (t.responseJSON) {
                        ...
                        if (t.responseJSON.data && t.responseJSON.data.error)
                      ...
                      , r = function(t) {
                        ...
                        return t.map((function(t) {
                            var i = t.text || t.label || ""
                              , a = t.id || t.value || "";
                            o.push(a),
                            t.children ? e += '<optgroup label="' + n.escAttr(i) + '">' + r(t.children) + "</optgroup>" : e += '<option value="' + n.escAttr(a) + '"' + (t.disabled ? ' disabled="disabled"' : "") + ">" + n.strEscape(i) + "</option>"
                        }
                        )),
                        e
                    };
                ...
                ,
                n.isGutenbergPostEditor = function() {
                ...
                g = function() {
                    h.forEach((function(t) {
                        n.isInView(t.el) && (t.callback.apply(this),
                        m(t.id))
                    }
                    ))
                }
                ...
                m = function(e) {
                    ...
                    ))).length || t(window).off("scroll resize", v).off("acfrefresh orientationchange", g)
                }
                ,
                function(e, i) {
                    e instanceof jQuery && (e = e[0]),
                    n.isInView(e) ? i.apply(this) : function(e, n) {
                        h.length || t(window).on("scroll resize", v).on("acfrefresh orientationchange", g),
                        h.push({
                            id: p++,
                            el: e,
                            callback: n
                ...
                n.once = function(t) {
                    var n = 0;
                    return function() {
                        return n++ > 0 ? t = e : t.apply(this, arguments)
                    }
                }
                ,
                n.focusAttention = function(e) {
                    ...
                    n.isInView(e) || (t("body, html").animate({
                ...
                n.onFocus = function(e, n) {
                    var i = !1
                      ...
                      , s = function(i) {
                        o !== i && (i ? (t(document).on("click", a),
                        e.on("blur", "input, select, textarea", a)) : (t(document).off("click", a),
                        e.off("blur", "input, select, textarea", a)),
                        o = i,
                        n(i))
                    };
                    e.on("click", r),
                ...
                ,
                n.disableForm = function(t) {
                    t.submitter && t.submitter.classList.add("disabled")
                }
                ,
        ...
        6891: () => {
            ...
            t.extend(n.prototype, {
                ...
                inherit: function(e) {
                    return e instanceof jQuery && (e = e.data()),
                    t.extend(this.data, e),
                    this
                },
                prop: function() {
                ...
                addElements: function(t) {
                    if (!(t = t || this.elements || null) || !Object.keys(t).length)
                        return !1;
                    for (var e in t)
                        this.addElement(e, t[e])
                },
                addElement: function(t, e) {
                    this["$" + t] = this.$(e)
                },
                addEvents: function(t) {
                    if (!(t = t || this.events || null))
                        return !1;
                    for (var n in t) {
                        var i = n.match(e);
                        this.on(i[1], i[2], t[n])
                ...
                trigger: function(t, e, n) {
                    ...
                    return n ? i.trigger.apply(i, arguments) : i.triggerHandler.apply(i, arguments),
                    this
                },
                addActions: function(t) {
                    if (!(t = t || this.actions || null))
                        return !1;
                    for (var e in t)
                        this.addAction(e, t[e])
                },
                removeActions: function(t) {
                    if (!(t = t || this.actions || null))
                        return !1;
                    for (var e in t)
                        this.removeAction(e, t[e])
                },
                ...
                addFilters: function(t) {
                    if (!(t = t || this.filters || null))
                        return !1;
                    for (var e in t)
                        this.addFilter(e, t[e])
                },
        ...
        9340: () => {
            ...
            new acf.Model({
                ...
                open: function(t) {
                    t.addClass("-open"),
                    t.find(".acf-panel-title i").attr("class", "dashicons dashicons-arrow-down")
                },
                close: function(t) {
                    t.removeClass("-open"),
                    t.find(".acf-panel-title i").attr("class", "dashicons dashicons-arrow-right")
                }
            })
        }
        ,
            ...
            acf.copyable = new acf.Model({
                ...
                initialize: function() {
                    if ("undefined" == typeof pagenow)
                        return;
                    if (!["edit-acf-field-group", "edit-acf-post-type", "edit-acf-taxonomy", "edit-acf-ui-options-page"].includes(pagenow))
                        return;
                    const e = t(document).find(".column-acf-key");
                    e && e.each((function() {
                        t(this).html(acf.copyable.makeCopyable(t(this)))
                    }
                    ))
                },
                makeCopyable: function(t) {
                    const e = acf.strSanitize(t.text())
                      , n = t.html();
                    let i = "copyable";
                    return navigator.clipboard || (i = `${i} copy-unsupported`),
                    n.replace(e, `<span class="${i}">${e}</span>`)
                },
                copyCopyable: function(e) {
                    if (e.stopPropagation(),
                    !navigator.clipboard || t(e.target).is("input"))
                        return;
                    let n;
                    n = t(e.target).hasClass("acf-input-wrap") ? t(e.target).find("input").first().val() : t(e.target).text().trim(),
                    navigator.clipboard.writeText(n).then(( () => {
                        t(e.target).closest(".copyable").addClass("copied"),
                        setTimeout((function() {
                            t(e.target).closest(".copyable").removeClass("copied")
                        }
                        ), 2e3)
                    }
                    ))
